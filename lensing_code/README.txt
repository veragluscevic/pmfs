...
3. pt_plot.py: plots the results generated by pt.py, as shown in Fig.8 in the paper.
...
6. spurB_z_v2.py: uses the results from covariance.py and the input files: global.txt and xs_table.txt (generated from the star formation models during EoR), to calculate the lensing contaminations to magnetic field detections. It also plots the result as shown in Fig.9 in our paper.
