...
\left\lbrace \left(1+(\widehat{\bf{k}}\cdot\widehat{{\bf{n}}})^2\right) \left[1-2\kappa\left(1+\frac{n_{\rm eff}(k)}{3}\right)+n_{\rm eff}(k)(\widehat{\bf{k}}\cdot\bm{\sigma}\cdot\widehat{{\bf{k}}})\right]\right.\\
...
\times(1+x_{\alpha,(2)}+x_{c,(2)})^2\left(1+\frac{11}{16}n_{\rm eff}(k)\right)(-\gamma_{23},\gamma_{13},0)^{\rm T}\\
