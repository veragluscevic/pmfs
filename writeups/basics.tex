...
\beq
\widetilde{I}(\vec{k}) = \frac{c(1+z)^2\chi(z)^2}{(2\pi)^3H(z)\nu_{21}}\widetilde{\mathcal{I}}(u,v,\eta),
...
\langle\widetilde{\mathcal{I}}(u,v,\eta) \widetilde{\mathcal{I}}^*(u',v',\eta')\rangle \\
 = \frac{1}{t_1}\left(\frac{2k_BT_\text{sys}}{A_e}\right)^2 \delta_D({u}-{u}')\delta_D({v}-{v}')\delta(\eta-\eta'),
\ega
...
\beq
P_1^N(\vec k) = \frac{1}{t_1(2\pi)^6}\frac{c(1+z)^2\chi^2(z)}{H(z)\nu_{21}}\left(\frac{2k_BT_\text{sky}}{A_e}\right)^2 ,
