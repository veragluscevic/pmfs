...
\times \left[\mu_0+\mu_1(\cos 2\varphi+2\gamma_{13}\sin 2\varphi)\right].
\ega
\eeq
...
13})} \times [1+2(\kappa+\gamma_{11})\sin^2\varphi\right.\\
...
\beq
\bga
B^{(\text{lens, 13})}=\frac{10(1+x_{\alpha,(2)}+x_{c,(2)})^2(2\mu_1+\frac{n_{\rm eff}}{2}\mu_0)}{C\bar{x}_{\rm B}(1+z)^2}\gamma_{13}\nonumber\\
