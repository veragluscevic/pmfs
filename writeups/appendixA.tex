...
\beq
\bga
\langle \widetilde{E}_i^*(\nu)\widetilde{E}_j(\nu)\rangle \propto \int_{\Omega_b} d\theta_xd\theta_y\mathcal{I}(\theta_x,\theta_y,\theta_\nu)\\
...
\beq
\rho_{ij}(\nu) = \frac{\int_{\Omega_b}d\theta_xd\theta_y\mathcal{I}(\theta_x,\theta_y,\theta_\nu)e^{2\pi i(u\theta_x+v\theta_y)}}{\int_{\Omega_b}d\theta_xd\theta_y\mathcal{I}(\theta_x,\theta_y,\theta_\nu)},
\label{eq:rho_mathcalI}
\eeq
where the denominator in the above formula approximately integrates to (for a small beam)
\beq
\int_{\Omega_b}d\theta_xd\theta_y\mathcal{I}(\theta_x,\theta_y,\theta_\nu) \approx
\Omega_b \mathcal{I}(\theta_x,\theta_y,\theta_\nu).
...
\beq
\rho_{ij}(\nu) = \frac{A_e}{2k_BT_\text{sky}}V(u,v,\theta_\nu),
\label{eq:rho_V}
\eeq
Combining the above expression and \eq{\ref{eq:var_rho}}, we get the final result of this derivation,
\beq
\langle|V(u,v,\theta_\nu)|^2\rangle = \left(\frac{2k_BT_\text{sky}}{A_e\sqrt{t_1\Delta \nu}}\right)^2\delta(u-u')\delta(v-v')\delta_{\theta_\nu\theta_{\nu'}},
\label{eq:Vrms_final}
\eeq
