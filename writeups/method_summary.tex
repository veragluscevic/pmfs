...
The main result of Paper I was a calculation of the 21--cm brightness--temperature $T_{\rm }$ fluctuation\footnote{Standard notation in the literature for this quantity is $\delta T_b$; however, we use $T$ to simplify our expressions.} as a function of the line--of--sight direction ${\bf{\widehat n}}$, in the frame of the emitting ensemble of atoms. The key result there is
\beq
\bga
