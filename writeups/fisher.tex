...
%%%   MORE HERE!!! FIGURES of saturation??
...
\beq
\bga
\text{SNR}^2 =  \frac{A_0^2}{2}  \int_{z_\text{min}}^{z_\text{max}}\frac{dV_\text{patch}}{{(P^N_{B_i}(z))^2}}(1+z)^4 
...
\beq
\bga
\text{SNR}^2 =  \frac{A_0^2}{2} \int_{z_\text{min}}^{z_\text{max}}\frac{dV_\text{patch}}{{(P^N_{B_i}(z))^2}}(1+z)^4 \int_0^{\pi} d\theta\\
...
\label{eq:snr_ints}
\eeq
When the last expression is evaluated at $A_0=1$, it provides the inverse of a value of $A_0$ detectable at $1\sigma$ sensitivity with a given experiment.