...
\\=
\frac{1}{2(2\pi)^3} \sum_{ij}  \frac{dV_\text{patch}}{{(P^N_{B_i}(z))^2}} \int d\vec K\left(P_{B_iB_j}(\vec K)\right)^2 (1+z)^4,
\ega
\label{eq:snr_z}
\eeq
...
\beq
\bga
\text{SNR}^2 =  \frac{A_0^4}{2(2\pi)^3}  \int_{z_\text{min}}^{z_\text{max}}\frac{dV_\text{patch}}{{(P^N_{B_i}(z))^2}}(1+z)^4 
...
\beq
\bga
\text{SNR}^2 =  \frac{A_0^4}{2(2\pi)^3} \int_{z_\text{min}}^{z_\text{max}}\frac{dV_\text{patch}}{{(P^N_{B_i}(z))^2}}(1+z)^4 \int_0^{\pi} d\theta\\
...
\beq
\text{SNR}^2 =  \frac{7A_0^4}{36\pi} \int_{z_\text{min}}^{z_\text{max}}\frac{dV_\text{patch}}{{(P^N_{B_i}(z))^2}}(1+z)^4 \left(\frac{1}{K_\text{min}^3}-\frac{1}{K_\text{max}^3}\right),
\label{eq:snr_ints}
\eeq
